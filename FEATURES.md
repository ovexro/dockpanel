...
> **Version**: v2.56.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| Regression-pin assertions | 941 (30 suites) | derived | every commit |
| Frontend pages | 51 | derived | every commit |
| DB migrations | 99 | derived | every commit |
