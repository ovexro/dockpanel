...
> **Version**: v2.120.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| Regression-pin assertions | 2342 (71 suites) | derived | every commit |
| Frontend pages | 53 | derived | every commit |
| DB migrations | 111 | derived | every commit |
