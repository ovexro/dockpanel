...
> **Version**: v2.191.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| Regression-pin assertions | 3768 (104 suites) | derived | every commit |
| Frontend pages | 53 | derived | every commit |
| DB migrations | 124 | derived | every commit |
