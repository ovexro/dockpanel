...
> **Version**: v2.139.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| HTTP routes | 832 (543 backend + 289 agent) | derived | every commit |
| Regression-pin assertions | 2840 (85 suites) | derived | every commit |
