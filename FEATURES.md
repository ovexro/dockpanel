...
> **Version**: v2.63.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| HTTP routes | 806 (524 backend + 282 agent) | derived | every commit |
| Regression-pin assertions | 1042 (30 suites) | derived | every commit |
