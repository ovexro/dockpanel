...
> **Version**: v2.138.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| HTTP routes | 830 (542 backend + 288 agent) | derived | every commit |
| Regression-pin assertions | 2756 (84 suites) | derived | every commit |
