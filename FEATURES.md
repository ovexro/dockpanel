...
> **Version**: v2.163.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| Regression-pin assertions | 3423 (93 suites) | derived | every commit |
| Frontend pages | 53 | derived | every commit |
| DB migrations | 118 | derived | every commit |
