...
> **Version**: v2.90.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| HTTP routes | 811 (530 backend + 281 agent) | derived | every commit |
| Regression-pin assertions | 1501 (49 suites) | derived | every commit |
