...
> **Version**: v2.47.2 | **Total**: 60+ major features, ~285 capabilities
>
...
| HTTP routes | 810 (528 backend + 282 agent) | derived | every commit |
| Regression-pin assertions | 450 (15 suites) | derived | every commit |
