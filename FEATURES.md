...
> **Version**: v2.113.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| Regression-pin assertions | 2195 (66 suites) | derived | every commit |
| Frontend pages | 52 | derived | every commit |
| DB migrations | 109 | derived | every commit |
