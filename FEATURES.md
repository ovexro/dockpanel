...
> **Version**: v2.144.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| Regression-pin assertions | 3014 (88 suites) | derived | every commit |
| Frontend pages | 53 | derived | every commit |
| DB migrations | 114 | derived | every commit |
