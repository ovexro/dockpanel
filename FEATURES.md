...
> **Version**: v2.109.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| HTTP routes | 821 (533 backend + 288 agent) | derived | every commit |
| Regression-pin assertions | 2131 (64 suites) | derived | every commit |
