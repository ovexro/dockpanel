...
> **Version**: v2.106.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| HTTP routes | 813 (532 backend + 281 agent) | derived | every commit |
| Regression-pin assertions | 2100 (63 suites) | derived | every commit |
