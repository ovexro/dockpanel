...
> **Version**: v2.81.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| Regression-pin assertions | 1283 (40 suites) | derived | every commit |
| Frontend pages | 51 | derived | every commit |
| DB migrations | 105 | derived | every commit |
