...
> **Version**: v2.184.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| Regression-pin assertions | 3638 (102 suites) | derived | every commit |
| Frontend pages | 53 | derived | every commit |
| DB migrations | 122 | derived | every commit |
