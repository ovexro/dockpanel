...
> **Version**: v2.193.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| Regression-pin assertions | 3802 (104 suites) | derived | every commit |
| Frontend pages | 53 | derived | every commit |
| DB migrations | 125 | derived | every commit |
