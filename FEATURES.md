...
> **Version**: v2.220.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| Regression-pin assertions | 4307 (129 suites) | derived | every commit |
| Frontend pages | 53 | derived | every commit |
| DB migrations | 127 | derived | every commit |
