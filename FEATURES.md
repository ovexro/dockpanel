...
> **Version**: v2.223.0 | **Total**: 60+ major features, ~285 capabilities
>
...
| Regression-pin assertions | 4326 (130 suites) | derived | every commit |
| Frontend pages | 53 | derived | every commit |
| DB migrations | 129 | derived | every commit |
