...
- **Secure cookie fix**: `BASE_URL` defaulted to `https://demo.dockpanel.dev`, causing `Secure` flag on cookies over HTTP. Fixed — defaults to empty, setup script sets from domain.
