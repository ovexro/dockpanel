...
<p align="center">
  ...
  Self-hosted. Docker-native. Written in Rust. Panel services run on <strong>~49MB of RAM</strong>. 821 HTTP routes. 148 app templates. 2192 regression assertions. ~46MB binaries. Zero subscriptions.
</p>
