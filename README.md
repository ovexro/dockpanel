...
<p align="center">
  ...
  Self-hosted. Docker-native. Written in Rust. Panel services run on <strong>~49MB of RAM</strong>. 812 HTTP routes. 148 app templates. 1980 regression assertions. ~45MB binaries. Zero subscriptions.
</p>
