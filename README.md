...
<p align="center">
  ...
  Self-hosted. Docker-native. Written in Rust. Panel services run on <strong>~49MB of RAM</strong>. 822 HTTP routes. 148 app templates. 2437 regression assertions. ~46MB binaries. Zero subscriptions.
</p>
