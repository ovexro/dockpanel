...
<p align="center">
  ...
  Self-hosted. Docker-native. Written in Rust. Panel services run on <strong>~49MB of RAM</strong>. 837 HTTP routes. 147 app templates. 4324 regression assertions. ~49MB binaries. Zero subscriptions.
</p>
