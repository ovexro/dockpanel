...
<p align="center">
  ...
  Self-hosted. Docker-native. Written in Rust. Panel services run on <strong>~49MB of RAM</strong>. 832 HTTP routes. 148 app templates. 2840 regression assertions. ~46MB binaries. Zero subscriptions.
</p>
