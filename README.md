...
<p align="center">
  ...
  Self-hosted. Docker-native. Written in Rust. Panel services run on <strong>~49MB of RAM</strong>. 839 HTTP routes. 147 app templates. 3613 regression assertions. ~47MB binaries. Zero subscriptions.
</p>
