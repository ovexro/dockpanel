          ...
          <div className="mt-4">
            ...
            <div className="flex flex-col gap-2">
              {branding.oauthProviders.includes("google") && (
                <a href="/api/auth/oauth/google" className="flex items-center justify-center gap-2 w-full py-2.5 bg-white text-gray-800 rounded-lg font-medium text-sm hover:bg-gray-100 transition-colors">
