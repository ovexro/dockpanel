      ...
      {showForm && (
        <form onSubmit={handleCreate} className="bg-dark-800 rounded-xl border border-dark-500 p-5 mb-6">
          ...
          <div className="flex gap-3">
            ...
            <button type="button" onClick={() => setShowForm(false)} className="px-4 py-2 bg-dark-700 text-dark-100 rounded-lg text-sm font-medium hover:bg-gray-200">
              Cancel
            </button>
          </div>
        </form>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors ${m.enabled ? "bg-rust-500" : "bg-gray-300"}`}
                      title={m.enabled ? "Pause" : "Resume"}
                    >
                      <span className={`inline-block h-3.5 w-3.5 transform rounded-full bg-dark-800 transition-transform ${m.enabled ? "translate-x-4" : "translate-x-1"}`} />
                    </button>
                    <button
