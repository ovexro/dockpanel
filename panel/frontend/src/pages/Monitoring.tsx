...
export default function Monitoring() {
  const [tab, setTab] = useState<"monitors" | "alerts">("monitors");
    ...
    <div className="p-6 lg:p-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6 pb-4 border-b border-dark-600">
        <div>
          ...
          <p className="text-sm text-dark-200 mt-1">Uptime monitors and alert management</p>
        </div>
      </div>
      ...
      {tab === "monitors" ? <MonitorsContent /> : <AlertsContent />}
    </div>
  );
}
