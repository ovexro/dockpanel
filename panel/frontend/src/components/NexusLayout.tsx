      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header className="h-16 border-b flex items-center justify-between px-6 shrink-0 bg-dark-900 border-dark-700">
          ...
          <div className="flex items-center gap-3">
            {/* Notification bell */}
            <Link to="/notifications" className="relative p-2 text-dark-400 hover:bg-dark-800 rounded-full transition-colors" title={state.notifCount > 0 ? `${state.notifCount} unread notification${state.notifCount === 1 ? "" : "s"}` : "Notifications"} aria-label="Notifications">
