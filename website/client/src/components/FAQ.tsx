...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes. Visit panel.example.com to explore the full panel interface with sample data — no signup required. You can also install DockPanel on your own server with one command.',
  },
  {
