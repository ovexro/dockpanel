          ...
          <div className="relative rounded-2xl border border-brand-500/30 bg-brand-500/[0.06] p-8 md:p-10 pricing-glow">
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
              {[
                ...
                'Nixpacks auto-build (30+ languages)',
                'Preview environments with TTL',
                'DNS management (Cloudflare + PowerDNS)',
                'Email management (Postfix + Dovecot)',
                'Uptime monitoring & alerts',
                'Security scanning & hardening',
                '2FA / TOTP + OAuth (Google, GitHub, GitLab)',
                'Auto-healing engine',
                'Smart diagnostics',
                'Developer CLI + Infrastructure as Code',
                'Multi-server management',
                'Reseller accounts & white-label',
                'WordPress Toolkit (vuln scan, bulk update)',
                'Migration wizard (cPanel, Plesk, HestiaCP)',
                'Traefik reverse proxy option',
                'Extension / plugin API (webhooks)',
