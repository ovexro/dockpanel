    ...
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-surface-950/80 backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <nav className="hidden items-center gap-6 md:flex">
          ...
          <a href="https://demo.dockpanel.dev" className="text-sm text-surface-200/70 transition hover:text-white">Demo</a>
          <a
      ...
      {mobileOpen && (
        <nav className="border-t border-white/5 bg-surface-950/95 px-6 py-4 backdrop-blur-xl md:hidden">
          <div className="flex flex-col gap-4">
            ...
            <a href="https://demo.dockpanel.dev" onClick={() => setMobileOpen(false)} className="text-sm text-surface-200/70 transition hover:text-white">Demo</a>
            <a
              href="https://github.com/ovexro/dockpanel"
