...
> **Reflects v2.98.0.** The version stamp, the template count and every
...
survivable. Fifty-seven suites, **1877 assertions**, all green at the current commit:
