...
> **Reflects v2.58.0.** The version stamp, the template count and every
...
survivable. Thirty suites, **987 assertions**, all green at the current commit:
...
| `unattended-host-scope-pin-e2e.sh` | 72 |
