...
> **Reflects v2.139.1.** The version stamp, the template count and every
...
survivable. Eighty-five suites, **2844 assertions**, all green at the current commit:

| Suite | Assertions |
|---|---|
| `ssl-controls-pin-e2e.sh` | 87 |
