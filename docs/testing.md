...
> **Reflects v2.84.0.** The version stamp, the template count and every
...
- **459 unit tests** across the crates — 309 in the backend, 150 in the agent.
...
survivable. Forty-three suites, **1383 assertions**, all green at the current commit:
