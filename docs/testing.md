...
> **Reflects v2.186.0.** The version stamp, the template count and every
...
survivable. One-hundred-three suites, **3678 assertions**, all green at the current commit:
...
| `client-role-and-server-ownership-pin-e2e.sh` | 36 |
