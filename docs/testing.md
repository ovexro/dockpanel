...
> **Reflects v2.161.0.** The version stamp, the template count and every
...
survivable. Ninety-three suites, **3409 assertions**, all green at the current commit:

| Suite | Assertions |
|---|---|
| `carry-sweep-pin-e2e.sh` | 88 |
| `ssl-controls-pin-e2e.sh` | 121 |
