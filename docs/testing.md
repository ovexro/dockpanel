...
> **Reflects v2.53.0.** The version stamp, the template count and every
...
survivable. Twenty-seven suites, **833 assertions**, all green at the current commit:
