...
> **Reflects v2.56.0.** The version stamp, the template count and every
...
survivable. Thirty suites, **941 assertions**, all green at the current commit:
...
| `unattended-host-scope-pin-e2e.sh` | 26 |
