...
> **Reflects v2.47.2.** The version stamp, the template count and every
...
survivable. Fifteen suites, **450 assertions**, all green at the current commit:
