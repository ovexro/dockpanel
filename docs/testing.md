...
> **Reflects v2.67.0.** The version stamp, the template count and every
...
survivable. Thirty suites, **1088 assertions**, all green at the current commit:
...
| `php-install-from-picker-pin-e2e.sh` | 36 |
...
| `unattended-host-scope-pin-e2e.sh` | 111 |
