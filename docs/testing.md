...
> **Reflects v2.132.0.** The version stamp, the template count and every
...
survivable. Seventy-nine suites, **2604 assertions**, all green at the current commit:
