...
> **Reflects v2.57.0.** The version stamp, the template count and every
...
survivable. Thirty suites, **956 assertions**, all green at the current commit:
...
| `unattended-host-scope-pin-e2e.sh` | 41 |
