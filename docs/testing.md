...
> **Reflects v2.188.0.** The version stamp, the template count and every
...
survivable. One-hundred-four suites, **3744 assertions**, all green at the current commit:
...
| `client-role-and-server-ownership-pin-e2e.sh` | 56 |
