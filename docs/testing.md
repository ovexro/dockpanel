...
> **Reflects v2.122.1.** The version stamp, the template count and every
...
survivable. Seventy-three suites, **2402 assertions**, all green at the current commit:
...
| `unattended-host-scope-pin-e2e.sh` | 115 |
