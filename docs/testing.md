...
> **Reflects v2.106.0.** The version stamp, the template count and every
...
survivable. Sixty-three suites, **2100 assertions**, all green at the current commit:
...
| `mail-sender-identity-pin-e2e.sh` | 35 |
