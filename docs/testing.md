...
> **Reflects v2.107.0.** The version stamp, the template count and every
...
survivable. Sixty-three suites, **2101 assertions**, all green at the current commit:
...
| `mail-sender-identity-pin-e2e.sh` | 36 |
