...
> **Reflects v2.90.0.** The version stamp, the template count and every
...
survivable. Forty-nine suites, **1501 assertions**, all green at the current commit:
