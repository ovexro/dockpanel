...
> **Reflects v2.176.0.** The version stamp, the template count and every
...
survivable. Ninety-nine suites, **3524 assertions**, all green at the current commit:
...
| `status-page-gate-pin-e2e.sh` | 29 |
...
| `billing-webhook-plan-source-pin-e2e.sh` | 15 |
