...
> **Reflects v2.163.0.** The version stamp, the template count and every
...
survivable. Ninety-three suites, **3423 assertions**, all green at the current commit:

| Suite | Assertions |
|---|---|
| `carry-sweep-pin-e2e.sh` | 88 |
| `ssl-controls-pin-e2e.sh` | 134 |
